...
- Responsibility focus: design intent, scope, acceptance, sequencing
- Default ownership: workflow and review artifacts only
- Allowed write paths: .workflow/<slug>/decisions.md, .workflow/<slug>/review-log.md, .workflow/<slug>/role-reviews.md, .workflow/<slug>/conflicts.md, .workflow/<slug>/assumptions.md, .workflow/<slug>/execution-board.md
- Result envelope path: .workflow/demo/agent-results/product-owner.md
...
- Stay inside these allowed write paths: .workflow/<slug>/decisions.md, .workflow/<slug>/review-log.md, .workflow/<slug>/role-reviews.md, .workflow/<slug>/conflicts.md, .workflow/<slug>/assumptions.md, .workflow/<slug>/execution-board.md
...
- When you finish or hand off, write the final report to `.workflow/demo/agent-results/product-owner.md` and return the same content in chat.
