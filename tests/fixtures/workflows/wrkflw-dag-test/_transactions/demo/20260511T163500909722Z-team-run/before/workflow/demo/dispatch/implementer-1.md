...
- Responsibility focus: code and tests for the active slice
...
- Result envelope path: .workflow/demo/agent-results/implementer-1.md
...
- When you finish or hand off, write the final report to `.workflow/demo/agent-results/implementer-1.md` and return the same content in chat.
