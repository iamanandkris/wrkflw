# Implementer 2 Dispatch Packet

- Workflow slug: demo
- Role: Implementer 2
- Slot: implementer-2
- Recommended agent type: worker
...
- Responsibility focus: optional parallel code and tests for a second slice
- Default ownership: assigned code/tests only
- Allowed write paths: declare concrete module/file prefixes before parallel team-run
- Result envelope path: .workflow/demo/agent-results/implementer-2.md
...
- Stay inside these allowed write paths: declare concrete module/file prefixes before parallel team-run
...
- When you finish or hand off, write the final report to `.workflow/demo/agent-results/implementer-2.md` and return the same content in chat.
