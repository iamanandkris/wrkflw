...
- Runtime mode: parallel-dag-level-team
...
- DAG node: Story 2: Add Approval Policy
- DAG level: 2
- DAG status: active
- DAG validation: valid
- DAG risk: high
- Needs deeper QA: yes
- Depends on: story-1
...
- Lane depends on: -
- Lane blocked by: -
- Ready now: Story 2: Add Approval Policy, Story 3: Add Audit Trail
